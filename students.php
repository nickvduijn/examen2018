...
<div class="container">
    ...
    <div class="search-container">
        <div class="input-group mb-3">
            ...
            <input type="text" id="searchbar" class="form-control" placeholder="Zoek een student.." aria-label="Zoeken" aria-describedby="basic-addon1">
        </div>
    </div>
        ...
        <div class="t-content">
            <table class="table table-hover">
                ...
                <tr class="clickable-row sfilter" data-href="student.php?id=<?php echo $user['id']; ?>">
                    ...
                    <td><?php if(empty($company[0]['name'])) : ?><i>Student is nog niet gekoppeld</i><?php else : ?><?php echo $company[0]['name'] ?><?php endif; ?></td>
                </tr>
                <?php endforeach; ?>
                </tbody>
            </table>
